...
angular.module("warhammer40k", ["ngAnimate", "ngCookies", "ngTouch", "ngSanitize", "ngResource", "ngRoute", "ngMaterial"]).config(["$routeProvider", function (e) {
    ...
    e.rule = null;
    var t = a.id;
    l.get("/rule/rest/" + t).success(function (l) {
        e.rule = l
    })
